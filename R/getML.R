...
mod <- SS_output("C:/Users/felip/Documents/Mako_Atlantic/BH/") ## folder where ss outputs are (rep file etc)


SSMethod.TA1.8.FC <- function(fit,
           type,
           fleet,
           part = 0:2,
           pick.gender = 0:3,
...
francisdat <- SSMethod.TA1.8.FC(mod, type = 'len', fleet = 1:5, plotit = T) %>% as.data.frame()
